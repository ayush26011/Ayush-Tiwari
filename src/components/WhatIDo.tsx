        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                web applications. Shipped production-ready features, payment
                integrations, and optimized database workflows.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing and developing deep learning models, computer vision
                systems, and Generative AI applications. Experience in deploying
                scalable ML pipelines and publishing research.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
